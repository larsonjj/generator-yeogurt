                    ...
                    describe('With Auth', function() {
                        it ('Creates expected files with expected content', function(done) {
                            var expected = [
                                ...
                                'client/scripts/views/layouts/one-column.js',
                                ...
                                'client/templates/layouts/one-column.hbs',
                            ...
                            var fileContentToTest = [
                                ...
                                ['client/scripts/views/layouts/one-column.js',/module\.exports/i],
                                ...
                                ['client/templates/layouts/one-column.hbs',/<\/div>/i],
                    ...
                    describe('With Auth', function() {
                        it ('Creates expected files with expected content', function(done) {
                            var expected = [
                                ...
                                'client/templates/layouts/one-column.jst',
                            ...
                            var fileContentToTest = [
                                ...
                                ['client/templates/layouts/one-column.jst',/<\/div>/i],
                    ...
                    describe('With Auth', function() {
                        it ('Creates expected files with expected content', function(done) {
                            var expected = [
                                ...
                                'client/templates/layouts/one-column.jade',
                            ...
                            var fileContentToTest = [
                                ...
                                ['client/templates/layouts/one-column.jade',/.one/i],
                    ...
                    describe('With Auth', function() {
                        it ('Creates expected files with expected content', function(done) {
                            ...
                            var fileContentToTest = [
                                ...
                                ['client/scripts/views/layouts/one-column.js',/define/i],
