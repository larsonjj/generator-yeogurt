...
describe('yeogurt generator', function () {
    ...
    it('creates expected files', function (done) {
        var expected = [
            ...
            'dev/dashboard/markup/components/c000-head.jade',
            'dev/dashboard/markup/components/c001-header.jade',
            'dev/dashboard/markup/components/c002-footer.jade',
            'dev/dashboard/markup/elements/all-elements.jade',
            'dev/dashboard/markup/elements/e000-heading.jade',
            'dev/dashboard/markup/pages/p000-homepage.jade',
            'dev/dashboard/markup/templates/t000-base.jade',
            'dev/dashboard/markup/templates/t001-one-column.jade',
