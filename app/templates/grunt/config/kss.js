...
module.exports = function(grunt) {
    ...
    grunt.config.set('kss', {
        options: {
            ...
            includePath: '<%%= yeogurt.dev %>/docs/styleguide/styleguide.<% if (cssOption === 'SASS') { %>scss<% } else if (cssOption === 'LESS') { %>less<% } else if (cssOption === 'None (Vanilla CSS)') { %>css<% } %>',<% if (cssOption === 'SASS') { %>
